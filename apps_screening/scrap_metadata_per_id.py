...
node_js_path = '/home/budi/indonesian_government/apps_screening/'
selected_app_id = '/home/budi/indonesian_government/apps_screening/province_app_id.csv'
selected_metadata = '/home/budi/indonesian_government/apps_screening/selected_metadata/'
prov_metadata_file = '/home/budi/indonesian_government/apps_screening/province_metadata.csv'
apps_not_found = '/home/budi/indonesian_government/apps_screening/app_not_found.csv'
...
def encode_metadata(app_id,res_path):
    ...
    try:
        with open(app_id_res,'r') as app_metadata:
            ...
            score = json_data['score'] if 'score' in json_data else None
            ...
            dev_email = json_data['developerEmail'] if 'developerEmail' in json_data else None
            dev_web = json_data['developerWebsite'] if 'developerWebsite' in json_data else None
            ...
            'install':install,'developer':developer,'dev_email':dev_email,'dev_web':dev_web,
            'release':release}
    except IOError:
        item_dict={'appId':app_id,'title':'error',
            'score': 'error','rating': 'error','review': 'error',#'comment':'error',
            'install':'error','developer':'error','dev_email':'error','dev_web':'error',
            'release':'error'}
    return item_dict
...
def main():
    ...
    print(metadata_df)
    metadata_df.to_csv(prov_metadata_file)
